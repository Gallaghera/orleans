using Vylon.Achievement.Grains;
using Vylon.Achievement.Interfaces;
using Xunit;

namespace Vylon.Achievement.Test.NonSilo
{
    public class HelloWorldNonSiloTests
    {
        ...
        //    IUserGrain grain = TestGrainFactory.CreateGrain<UserGrain>(id);


        //    var t = grain.GetUserData();
